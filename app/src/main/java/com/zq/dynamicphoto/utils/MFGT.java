...
import com.zq.dynamicphoto.ui.MyTwoCodeActivity;
...
public class MFGT {
    ...
    public static void gotoMyTwoCodeActivity(Activity activity) {
        activity.startActivity(new Intent(activity, MyTwoCodeActivity.class));
    }
}
