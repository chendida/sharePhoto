...
import com.zq.dynamicphoto.waterutil.Point2D;
import com.zq.dynamicphoto.waterutil.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = MyApplication.getInstance().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = MyApplication.getInstance().getResources().getDrawable(R.drawable.close_water);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void setmImageRect(Rect imageRect){
