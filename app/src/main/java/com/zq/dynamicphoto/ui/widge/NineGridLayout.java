...
public abstract class NineGridLayout extends ViewGroup {
    ...
    public void setUrlList(List<String> urlList,Boolean flag) {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            boolean isShowDefualt = displayOneImage(imageView, url, mTotalWidth,isVideo);
            if (isShowDefualt) {
...
//        params.width = width;
     ...
     */
    protected abstract boolean displayOneImage(RatioImageView imageView, String url, int parentWidth,Boolean flag);
