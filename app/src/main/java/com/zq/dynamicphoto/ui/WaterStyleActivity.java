...
public class WaterStyleActivity extends BaseActivity {
    ...
    private WaterMouldFragment waterMouldFragment;
    private WaterPageAdapter pageAdapter;
    @Override
    ...
    protected void initData() {
        pageAdapter = new WaterPageAdapter(getSupportFragmentManager());
    ...
    private class WaterPageAdapter extends FragmentPagerAdapter {

        private WaterPageAdapter(FragmentManager fm) {
            super(fm);
        }
